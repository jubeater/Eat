...
public class YelpAPI {
    ...
    private static final String CONSUMER_KEY = "yLeCvBn4PL4H6S4Bj-pqbw";
    private static final String CONSUMER_SECRET = "TxlPdbf2ATKwttLRneXDTDIieBM";
    private static final String TOKEN = "1ZuSVlkjP8vcI8aB4_3RuWMaLvs2zp0B";
    private static final String TOKEN_SECRET = "cOf7MsrAE-ZR8r79pxFKLOr84iw";
